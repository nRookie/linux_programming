...
int main()
{
	...
	// Having declared a pointer to a dbm type structure, now open
	// your test database for reading and writing ,creating it if necessary:
	...
	// This is the first letter of each string and the integer.
	// This key is then identified with the key_datum,while the 
	// data_datum refers to the items_to_store entry. Then you
