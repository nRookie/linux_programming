...
/* Now that you have some data structures,you can define some access routines that you'll need. Functions with cdc_ are for catalog entries; functions with cdt_ are for track entries:*/
